...
public class ChangedBlockListenerImp implements ChangedBlocksListener {
	...
	//private final NetworkStreamSender sender;
        private final BlockChangeProcessor blockChangeProcessor;
	
	//public ChangedBlockListenerImp(NetworkStreamSender sender) {
        public ChangedBlockListenerImp(BlockChangeProcessor blockChangeProcessor) {
		this.blockChangeProcessor = blockChangeProcessor;
	}
	
	@Override
	public void onChangedBlock(BlockMessage blockPosition) {
		blockChangeProcessor.send(blockPosition);
	}
